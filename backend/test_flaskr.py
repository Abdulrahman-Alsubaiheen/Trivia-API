...
#_______________________________________________________________________________________#
    ...
    def test_delete_questions(self): 
        res = self.client().delete('/questions/4') # must change the id every time i runing the test
        data = json.loads(res.data)
...
#_______________________________________________________________________________________#
    ...
    def test_create_new_question(self):
        res = self.client().post('/questions', json=self.new_question) # json=self.new_book ( that i create up in the setup )
        data = json.loads(res.data)
